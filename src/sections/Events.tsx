    ...
    <section id="events" className="py-24 px-6 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Large tile: campfire video */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="md:col-span-2 md:row-span-2 relative rounded-2xl overflow-hidden border border-border group min-h-[320px]"
          >
            <video
          ...
          {/* Smaller tile: campus outing video */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.15 }}
            className="relative rounded-2xl overflow-hidden border border-border group min-h-[220px]"
          >
            <video
          ...
          {/* Placeholder tile: New Year 2026 — awaiting real photos */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.3 }}
            className="relative rounded-2xl overflow-hidden border border-dashed border-border bg-surface/40 min-h-[220px] flex flex-col items-center justify-center text-center p-6"
          >
